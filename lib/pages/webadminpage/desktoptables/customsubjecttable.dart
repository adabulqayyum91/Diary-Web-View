...
class CustomTableSubject extends StatefulWidget {
  CustomTableSubject({this.constraints});
  BoxConstraints constraints;
  @override
  _CustomTableSubjectState createState() => _CustomTableSubjectState();
}

class _CustomTableSubjectState extends State<CustomTableSubject> {
