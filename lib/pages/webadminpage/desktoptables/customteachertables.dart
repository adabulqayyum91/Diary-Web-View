...
class CustomTeacherTable extends StatefulWidget {
  CustomTeacherTable({this.constraints});
  BoxConstraints constraints;
  @override
  _CustomTeacherTableState createState() => _CustomTeacherTableState();
}

class _CustomTeacherTableState extends State<CustomTeacherTable> {
