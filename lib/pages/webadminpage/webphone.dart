...
import 'phonetables/customstudenttable.dart';
import 'phonetables/customsubjecttable.dart';
import 'phonetables/customtableclasses.dart';
import 'phonetables/customteachertables.dart';

class WebPhoneAdminClasses extends StatelessWidget {
  WebPhoneAdminClasses({this.constraints, });
                  ...
                  child: Column(
                    children: [
                      ...
                      ListView.builder(
                          shrinkWrap: true,
                          padding:
                          EdgeInsets.only(top: constraints.minHeight * 0.04),
              ...
              children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: CircleAvatar(
                            backgroundColor: Color(0xFF253274),
                          ...
                          children: [
                            ...
                            PopupMenuButton(
                                icon: Icon(
                                  ...
                                  size: constraints.minWidth*0.04,
                ...
                Expanded(
                  ...
                  child: Padding(
                      ...
                      child: Obx(() =>
                          adminDrawerController.currentdrawer.value == 0
                              ? CustomPhoneTableClasses(
                                  constraints: constraints,
                                )
                              : adminDrawerController.currentdrawer.value == 1
                                  ? CustomPhoneTeacherTable(
                                      constraints: constraints,
                                    )
                                  : adminDrawerController.currentdrawer.value == 2
                                      ? CustomPhoneStudentTable(
                                          constraints: constraints,
                                        )
                                      : CustomPhoneTableSubject(
                                          constraints: constraints))),
                ),
              ],
            ),
                            ...
                            child: ElevatedButton(
                                ...
                                child: Center(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                        color: Color(0xFFFFFFFF),
                                        fontSize: constraints.minWidth * 0.012,
                                        fontFamily: roboto),
                                  ),
                                )),
                          ),
