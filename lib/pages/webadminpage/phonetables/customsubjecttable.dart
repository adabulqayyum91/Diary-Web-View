...
class CustomPhoneTableSubject extends StatefulWidget {
  CustomPhoneTableSubject({this.constraints});
  BoxConstraints constraints;
  @override
  _CustomPhoneTableSubjectState createState() => _CustomPhoneTableSubjectState();
}

class _CustomPhoneTableSubjectState extends State<CustomPhoneTableSubject> {
