...
class CustomPhoneTableClasses extends StatefulWidget {
  CustomPhoneTableClasses({this.constraints});
  BoxConstraints constraints;
  @override
  _CustomPhoneTableClassesState createState() => _CustomPhoneTableClassesState();
}

class _CustomPhoneTableClassesState extends State<CustomPhoneTableClasses> {
