...
import 'package:dairyadmin/controllers/studentscontroller.dart';
import 'package:dairyadmin/controllers/teachercontroller.dart';
...
class CustomPhoneStudentTable extends StatefulWidget {
  CustomPhoneStudentTable({this.constraints});
  BoxConstraints constraints;
  @override
  _CustomPhoneStudentTableState createState() => _CustomPhoneStudentTableState();
}

class _CustomPhoneStudentTableState extends State<CustomPhoneStudentTable> {
  StudentController classescontroller = Get.put(StudentController());
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: TextField(
                                  style: TextStyle(
                                    fontSize:
                                    widget.constraints.minWidth * 0.029,
                                    fontFamily: roboto,
                                  ),
                                  ...
                                  decoration: InputDecoration(
                                      ...
                                      suffixIcon: Icon(
                                        Icons.search,
                                        size:
                                        widget.constraints.minWidth * 0.025,
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(
                                width: widget.constraints.minWidth * 0.03,
                              ),
                              Icon(
                                Icons.arrow_back_ios_rounded,
                                size: widget.constraints.minWidth * 0.019,
                                color: Color(0xFF606F89),
                              ),
                              SizedBox(
                                width: widget.constraints.minWidth * 0.03,
                ...
                child: Stack(
                  ...
                  children: [
                    Padding(
                      ...
                      widget.constraints.minWidth * 0.035,
                          right: widget.constraints.minWidth * 0.035,
                          bottom: 5
                      ),
                      child: Form(
                        key: _formKey,
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                        ...
                                        fontSize:
                                        widget.constraints.minWidth * 0.05,
    ...
    showDialog(
        ...
        builder: (context) {
          return Dialog(
            ...
            child: Center(
              child: Container(
                height: widget.constraints.minHeight * 0.77,
